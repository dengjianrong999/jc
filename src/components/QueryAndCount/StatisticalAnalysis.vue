	...
	export default {
		...
		methods: {
			...
			select() {
				...
				this.myoption.series[0].data = [2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 175.6, 182.2, 48.7, 18.8,
					26.4, 28.7, 70.7, 175.6, 182.2, 48.7
				];
				this.myoption.series[1].data = [2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 76.7, 135.6, 162.2, 76.7,
					135.6, 162.2, 25.6, 76.7, 135.6, 162.2
				];
				this.myChart.setOption(this.myoption);
			},
			// 清空
